...
//
//@Service("initFormChange")
//@Qualifier()
////@Qualifier("sqlSessionTemplate")
//@Scope("prototype")
//public class InitFormChange extends ApiRequestTemplate {
//    //@Autowired
//
...
//
//    public InitFormChange(Map<String, String> reqData) {
//        super(reqData);
//    }
//
//    @Override
//    public void requestParamValidation() throws RequestParamException {
////        if (StringUtils.isEmpty(this.reqData.get("frm_nm"))) {
////            throw new RequestParamException("frm_nm 이 없습니다.");
////        }
...
//            throw new RequestParamException("reg_id 이 없습니다.");
//        }
//    }
//
//    @Override
...
//        int result_value = -1;
//        
//        result_value = sqlSession.update("jumps.setInitFormByRegid", this.reqData);
//                
//        if(result_value != -1)
//        {   
