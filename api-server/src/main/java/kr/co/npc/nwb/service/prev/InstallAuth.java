...
//@Scope("prototype")
//public class InstallAuth extends ApiRequestTemplate {
//    //@Autowired
//
//    @Resource(name="sqlSession_dsl")    
//    private SqlSession sqlSession_dsl;
//
//    public InstallAuth(Map<String, String> reqData) {
//        super(reqData);
//    }
//
//    @Override
...
//        String reqeust_time =dateFormat.format(dt).trim();
////        System.out.println("request_time:"+reqeust_time);
//        this.reqData.put("request_time", reqeust_time);
//        
//        result_value = sqlSession_dsl.insert("installs.insertAuthRequest", this.reqData);
//                
//        if(result_value != -1)
//        {   
//            
...
//            this.apiResult.addProperty("request_time", dateFormat.format(dt));               
//        }
//        else 
//        {
//            // 데이터 없음.
