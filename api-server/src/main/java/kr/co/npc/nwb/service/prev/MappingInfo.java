...
//@Service("mappingInfo")
//@Scope("prototype")
//public class MappingInfo extends ApiRequestTemplate {
//    //@Autowired
//
...
//    
//    public MappingInfo(Map<String, String> reqData) {
//        super(reqData);
//    }
//
//    @Override
...
//        if(sqlSession != null)
//        {
//            result = sqlSession.selectList("mappings.mappingList", this.reqData);
//            
//            if (result != null) {
//                
