...
//@Service("popupInfo")
//@Scope("prototype")
//public class PopupInfo extends ApiRequestTemplate {
//    //@Autowired
//
...
//
//    public PopupInfo(Map<String, String> reqData) {
//        super(reqData);
//    }
//
//    @Override
...
//        }
//        if (StringUtils.isEmpty(this.reqData.get("popup_nm"))) {
//            throw new RequestParamException("popup_nm 가 없습니다.");
//        }
//    }
//
//    @Override
...
//        if(sqlSession != null)
//        {
//            result = sqlSession.selectList("popups.popupList", this.reqData);
//            
//            if (result != null) {
//                
//                JsonArray popupList = new JsonArray();
...
//                    popup = new JsonObject();
//                    for(String key : keys)
//                    {                        
//                        popup.addProperty(key, data.get(key).toString());                            
//                    }                      
//                    popupList.add(popup); 
//                }
...
//                this.apiResult.add("popups", popupList);               
//            }
//            else {
//                // 데이터 없음.
